...
export const WORKFLOW_SCENARIOS: Record<string, WorkflowScenario> = {
  ...
  'code-review': {
    ...
    steps: [
      ...
      },
      {
        order: 2,
        tool: 'audit',
        parameters: { action: 'start', path: './src', analyzers: ['solid', 'dry', 'documentation'], minSeverity: 'advisory' },
  ...
  'large-audit-handling': {
    ...
    steps: [
      {
        order: 1,
        tool: 'audit',
        parameters: { action: 'start', path: '.', analyzers: ['solid'], minSeverity: 'advisory', analyzerConcurrency: 2 },
    ...
    tips: [
      'minSeverity defaults to advisory — keep it there so no finding is hidden',
