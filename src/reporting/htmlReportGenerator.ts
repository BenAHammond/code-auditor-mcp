...
function getDefaultCSS(theme: 'light' | 'dark'): string {
  ...
  return `
    ...
    .stat-card.advisory { border-left: 4px solid ${colors.advisory}; }
    ...
    .violation-card.advisory { border-left: 4px solid ${colors.advisory}; }
